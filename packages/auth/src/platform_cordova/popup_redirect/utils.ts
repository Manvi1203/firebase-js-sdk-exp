...
export const _cordovaUtilsInternal = {
  async _generateHandlerUrl(
    auth: AuthInternal,
    event: AuthEvent,
  ...
  _checkCordovaConfiguration(auth: AuthInternal): void {
...
export async function _generateHandlerUrl(
  ...
  return _cordovaUtilsInternal._generateHandlerUrl(auth, event, provider);
}

export async function _validateOrigin(auth: AuthInternal): Promise<void> {
  return _cordovaUtilsInternal._validateOrigin(auth);
}

export function _performRedirect(
  handlerUrl: string
): Promise<InAppBrowserRef | null> {
  return _cordovaUtilsInternal._performRedirect(handlerUrl);
}
...
export async function _waitForAppResume(
  ...
  return _cordovaUtilsInternal._waitForAppResume(auth, eventListener, iabRef);
}

export function _checkCordovaConfiguration(auth: AuthInternal): void {
  return _cordovaUtilsInternal._checkCordovaConfiguration(auth);
}
